...
## 1. Request Parameters  
    ...
    Date Completed: 2021-11-08T22:23:08.554432  

    Id: 085e1aad-9dce-4756-80db-76d9d3cf8926  

    Details:  

        Input Vector Name:            Límite sitio RAMSAR/Limite_Sitio_Ramsar_modificado_UTM20S
...
- ramsar-MYD13Q1-006-metadata.xml
- ramsar-granule-list.txt
- ramsar-request.json
- MYD13Q1-006-250m-16-days-VI-Quality-lookup.csv
- MYD13Q1-006-250m-16-days-VI-Quality-Statistics-QA.csv
- MYD13Q1-006-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 824  
Total Size of Extracted Data Files: 56.75 MB  
...
- Didan, K. (2015). MYD13Q1 MODIS/Aqua Vegetation Indices 16-Day L3 Global 250m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-11-08 from https://doi.org/10.5067/MODIS/MYD13Q1.006. Accessed November 8, 2021.

## 10. Software Citation  

AppEEARS Team. (2021). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.66. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed November 8, 2021. https://lpdaacsvc.cr.usgs.gov/appeears
